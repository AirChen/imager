...
namespace
{
    std::filesystem::path ExeDir()
    {
        ...
        std::string exe_path = "/root/ws/imager/build/bin";
...
namespace AIHoloImager
{
    ...
    {
    public:
        explicit Impl(const std::filesystem::path& tmp_dir): exe_dir_(ExeDir()), tmp_dir_(tmp_dir), python_system_(exe_dir_), sfm_(tmp_dir_), mesh_recon_(exe_dir_, python_system_) {}
